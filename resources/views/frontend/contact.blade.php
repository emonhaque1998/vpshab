            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="wrapper">
                        ...
                        <div class="subheading">Don't worry! We have support premium 24/7/365. We are looking forward
                            waiting for your contact.</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="help-container bg-colorstyle">
                            <a href="#" class="help-item">
                                <div class="img">
                                    <div class="lazyload">
                                        <svg class="svg ico" width="32" height="32" viewBox="0 0 32 32">
                                            <path fill="#5e686c"
                                ...
                                <div class="inform">
                                    ...
                                    <div class="description seccolor">Talk to one of our live representatives.
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="help-container bg-colorstyle">
                            <a href="#ticket" class="help-item gocheck">
                                <div class="img">
                                    <div class="lazyload">
                                        <svg class="svg ico" viewBox="0 0 32 32">
                                            <path fill="#5e686c"
                                ...
                                <div class="inform">
                                    ...
                                    <div class="description seccolor">Caring Support, talk a expert 24/7, 365 days.
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="login" class="help-item">
                                <div class="img">
                                    <div class="lazyload">
                                        <svg class="svg ico" viewBox="0 0 32 32">
                                            <path fill="#5e686b"
                                                d="M16 31.813c-6.348 0-11.512-5.164-11.512-11.512S9.652 8.789 16 8.789c6.348 0 11.512 5.164 11.512 11.512S22.348 31.813 16 31.813zm0-22.172c-5.878 0-10.659 4.782-10.659 10.659S10.123 30.96 16 30.96c5.878 0 10.659-4.782 10.659-10.66S21.877 9.641 16 9.641z" />
                                            <path id="svg-ico" fill="#ee5586"
                                                d="M16 24.04a.426.426 0 0 1-.426-.426v-5.116a.426.426 0 1 1 .852 0v5.117a.426.426 0 0 1-.426.426zm5.29-16.16a.426.426 0 0 1-.426-.426v-3.4a2.98 2.98 0 0 0-2.979-2.975h-3.768a2.98 2.98 0 0 0-2.979 2.975v3.4a.426.426 0 1 1-.852 0v-3.4A3.834 3.834 0 0 1 14.118.227h3.768a3.834 3.834 0 0 1 3.832 3.827v3.4a.426.426 0 0 1-.427.426z" />
                                        </svg>
                                    </div>
                                </div>
                                <div class="inform">
                                    <div class="title mergecolor">Cliente Area</div>
                                    <div class="description seccolor">Are you an existing customer, login your area.
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="faq" class="help-item">
                                <div class="img">
                                    <div class="lazyload">
                                        <svg class="svg ico" viewBox="0 0 32 32">
                                            <path id="svg-ico" fill="#ee5586"
                                                d="M16.113 25.962c-1.2 0-2.175-.975-2.175-2.175s.975-2.175 2.175-2.175 2.175.975 2.175 2.175-.975 2.175-2.175 2.175zm0-3.474c-.719 0-1.306.587-1.306 1.306s.588 1.306 1.306 1.306c.719 0 1.306-.587 1.306-1.306a1.309 1.309 0 0 0-1.306-1.306z" />
                                            <path fill="#5e686b"
